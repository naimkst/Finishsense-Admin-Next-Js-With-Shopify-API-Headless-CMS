...
const Profile = () => {
  ...
  const getMetafieldValue = (data: any, key: any) => {
    const metafield = data?.edges.find((item: any) => item.node.key === key);
  ...
  const { control, handleSubmit, setValue } = useForm({
    defaultValues: {
      ...
      title: getMetafieldValue(user?.metafields, "title"),
      email: user?.email,
      phone: user?.defaultAddress?.phone,
      company: getMetafieldValue(user?.metafields, "company"),
  ...
  useEffect(() => {
    ...
    setValue("title", getMetafieldValue(user?.metafields, "title"));
    setValue("email", user?.email);
    setValue("phone", user?.defaultAddress?.phone);
    setValue("company", getMetafieldValue(user?.metafields, "company"));
    ...
    setValue("state", user?.defaultAddress?.province);
    setValue("zip", user?.defaultAddress?.zip);
    setValue("country", user?.defaultAddress?.country);
  }, [user]);

  const updateCustomer = async (formData: any) => {
    setLoading(true);
    const response = await fetch("/api/customerUpdate", {
      method: "POST",
  ...
  const onSubmit: SubmitHandler<any> = (data) => {
    const formData = {
      ...
      metafields: [
        {
          key: "title",
          value: getMetafieldValue(user?.metafields, "title"),
          namespace: "custom", // Optional
        },
        {
          key: "company",
          value: getMetafieldValue(user?.metafields, "company"),
          namespace: "custom", // Optional
        },
      ],
    };
      ...
      <div className="content-area">
        <div className="container-fluid">
          <div className="product-area">
            ...
            <PerfectScrollbar>
              <div className="product-wrap accountProfile">
                <div className="product-items">
                  <form action="" onSubmit={handleSubmit(onSubmit)}>
                    <div className="row">
                      ...
                      <div className="col-12 profileButton">
                        <div className="form-group">
                          <button type="submit">
